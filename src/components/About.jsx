export default function About() {
  return (
    <section id="about" className="py-20 px-24 text-white">

      {/* Full viewport hero */}
      <div className="min-h-screen flex flex-col pb-24">
      <h2 className="text-3xl font-bold text-purple-500 text-left mb-6">
      ...
      {/* About Cards */}
        <div className="grid md:grid-cols-3 gap-6 mt-16 items-center">
          {[
