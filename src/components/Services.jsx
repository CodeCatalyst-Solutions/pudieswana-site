import { Wrench, Trash2, Bus, Brush, Building2, Package, Zap } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 text-center">
        ...
        <div className="min-h-screen flex flex-col items-center justify-center pb-24 px-4">
          <h1 className="text-purple-500 text-3xl sm:text-4xl md:text-5xl font-bold leading-tight mb-6">
            ...
            <span className="text-gray-300 text-xl sm:text-2xl font-normal">Modern, Reliable, Corporate-strength.</span>
          </h1>
          <div className="flex flex-col sm:flex-row justify-center gap-4 w-full sm:w-auto">
            <Link to="/contact"><button className="w-full sm:w-auto bg-purple-600 hover:bg-purple-700 px-6 py-3 rounded-full font-semibold">Explore Services</button></Link>
            <Link to="/contact"><button className="w-full sm:w-auto border border-green-400 text-green-400 hover:bg-green-400 hover:text-black px-6 py-3 rounded-full font-semibold">Contact Us</button></Link>
          </div>
        </div>
